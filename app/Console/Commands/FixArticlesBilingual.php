...
class FixArticlesBilingual extends Command
{
    ...
    protected function translateArticle(
        ...
        $prompt = $this->prompt(
            'article_bilingual_fix',
            'Одноразове виправлення двомовності статей (легасі)',
            "Ти — професійний перекладач і редактор блогу. Переклади наступну статтю "
                . "на {{target_language}} мову. Це має бути якісний, природний текст рідною мовою — "
                ...
                . "Кожен буквальний символ \" усередині JSON-рядка ламає всю відповідь, тому НАДІЙНІШЕ "
