 ...
 * @property-read mixed $avatar_gradient
 * @property-read mixed $avatar_text
 * @property-read false|string $created_date
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereSiteUrl($value)
