...
@section('content')
    <form action="{{ action('Admin\Seo\Seo@update', ['index' => 'ad-user']) }}" method="post">
        @csrf
        <div class="row">
            <div class="col-8">
                <div class="card">
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><span class="text-danger" style="background: #eee">---ads_count---</span> <span class="float-right">Количество объявлений</span></p>
