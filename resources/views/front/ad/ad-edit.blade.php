            ...
            <form action="{{ route('ad.update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="steps-content" id="step-2" style="width: 600px;margin: 0 auto;max-width: 100%;">
                    ...
                    <div class="form-group upload-file">
                        ...
                        <span class="form-help">Загрузите новые изображения. <b>Файлы, которые были добавлены ранее будут удалены.</b> Допустимое количество загружаемых файлов: 5. Максимальный размер файла: 1024 KB. Для выбора нескольких изображений - зажмите ctrl и выберите соответствующие файлы.</span>
                    </div>
